    ...
    return (
        ...
        <div style={{width: 240, height: "100vh", position: "fixed"}}>
            <Sidenav defaultOpenKeys={['3', '4']} activeKey={router.pathname} style={{height: "100%"}}>
                <Sidenav.Body>
                    <div className={`d-flex w-100`} style={{ padding: '1rem 0', marginLeft: '1rem' }}><h4>Full Schedule</h4></div>
                    <Nav>
                        ...
                        <Nav.Item as={NavLink} href="/admin/dashboard/analytics" eventKey="/admin/dashboard/analytics"
                                  icon={<FontAwesomeIcon icon={faChartBar}/>}>
                            Analytics
                        </Nav.Item>
                        <Nav.Item as={NavLink} href="/admin/dashboard/promotions" eventKey="/admin/dashboard/promotions"
